...
from iep.models import Seq2Seq, LstmModel, CnnLstmModel, CnnLstmSaModel
import utils
...
# Output options
parser.add_argument('--checkpoint_path', default='../exps/')
...
def main(args):
    ...
    save_dir = args.checkpoint_path + args.model_type
    if not os.path.isdir(save_dir):
        os.mkdir(save_dir)
    args.checkpoint_path = save_dir + '/checkpoint.pt'
